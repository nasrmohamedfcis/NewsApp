...
public class CnnActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url ="https://newsapi.org/v1/articles?source=cnn&sortBy=top&apiKey=d72174043b224f7cbace25cd241989fc";
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(CnnActivity.this, "No Internet Connection", Toast.LENGTH_SHORT).show();
            }
        });
