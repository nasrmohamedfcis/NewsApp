...
public class BbcSportsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bbc_sports);
        ...
        String url ="https://newsapi.org/v1/articles?source=bbc-sport&sortBy=top&apiKey=d72174043b224f7cbace25cd241989fc";
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(BbcSportsActivity.this, "No Internet Connection", Toast.LENGTH_SHORT).show();
            }
        });
